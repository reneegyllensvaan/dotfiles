...
nnoremap <Space>wG :<C-u>call <SID>resize_to_golden_ratio()<CR>
nnoremap <C-W>G :<C-u>call <SID>resize_to_golden_ratio()<CR>
...
function! GR()
  let current_wininfo = getwininfo()
  let winnr_cur = 1
  while winnr_cur < winnr('$')
    echo getwininfo()
    let winnr_cur += 1
  endwhile
endfunction
